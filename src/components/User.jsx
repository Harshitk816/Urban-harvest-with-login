...
const User=(props)=>{
    ...
    return(
         <div className="user-card flex w-9/12 mx-auto my-4 bg-gray-50 rounded-2xl shadow-lg p-4 2xs:max-xs:items-center 2xs:max-xs:flex-col xl:w-9/12 lg:w-8/12 md:w-7/12 sm:w-9/12 xs:w-10/12 2xs:w-11/12  ">
          ...
          <h1 className="font-bold  text-3xl py-3 2xs:max-sm:text-sm">Mid-Term Team Project</h1>
          ...
          <p className=" font-normal text-sm 2xs:max-sm:text-xs text-balance me-4 leading-6">
            This website is created for the Mid-term Evaluation by <b>Harshit</b> and <b>Aman</b>. We have used various tech features to create this website. We will leave the links below.
          </p>
        </div>
