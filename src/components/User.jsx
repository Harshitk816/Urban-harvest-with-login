...
const User=(props)=>{
    ...
    return(
         <div className="user-card flex w-9/12 mx-auto my-4 bg-gray-50 rounded-2xl shadow-lg p-4 2xs:max-xs:items-center 2xs:max-xs:flex-col xl:w-9/12 lg:w-8/12 md:w-7/12 sm:w-9/12 xs:w-10/12 2xs:w-11/12  ">
          ...
          <h1 className="font-bold  text-3xl py-3 2xs:max-sm:text-sm">{name}</h1>
          <h2 className="text-xl py-3 2xs:max-sm:text-sm">Frontend Developer</h2>
          <p className=" font-normal text-sm 2xs:max-sm:text-xs text-balance me-4 leading-6">
            This website is created as a part of my Learning process of React. I have used various tech features to create this website. I will leave the links below.
          </p>
        </div>
        <div className="w-4/12 2xs:max-xs:w-6/12 2xs:max-xs:pt-6 relative">

          <img className=" w-full rounded-2xl" src={avatar_url}></img>
        </div>
